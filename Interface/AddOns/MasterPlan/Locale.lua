...
L == "zhCN" and {
	...
	["Follower XP"] = "追随者经验",
	["Future Mission #%d"] = "下版本任务#%d", -- Needs review
	...
	["Mission expiration"] = "任务过期时间", -- Needs review
	["Mission level"] = "任务等级",
	["Mission order:"] = "任务排序：",
	["Missions of Interest"] = "任务模拟器", -- Needs review
	["Mitigated threats"] = "更少的威胁", -- Needs review
	["Potential counters:"] = "潜在反制能力：",
	Ready = "就绪",
	["Redundant followers:"] = "模拟后多余的追随者：", -- Needs review
	["Reward: %s XP"] = "奖励：%s 经验",
