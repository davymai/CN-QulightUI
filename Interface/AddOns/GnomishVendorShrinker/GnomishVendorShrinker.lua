...
editbox:SetScript("OnTextChanged", function(self)
	...
	searchstring = t ~= "" and t ~= "搜索..." and t:lower() or nil
	Refresh()
end)
...
editbox:SetScript("OnEnter", function(self)
	...
	GameTooltip:AddLine("输入物品名称搜索")
	GameTooltip:AddLine(" ")
	GameTooltip:AddDoubleLine("类型搜索:", "拾取绑定   装备绑定   使用绑定", nil,nil,nil, 255,255,255)
	GameTooltip:AddDoubleLine(" ", "账号绑定   任务", 255,255,255, 255,255,255)
	GameTooltip:AddDoubleLine(" ", "ilvl>=378(装等)  ilvl=359(装等)", 255,255,255, 255,255,255)
	GameTooltip:AddDoubleLine(" ", "q=史诗   q<4", 255,255,255, 255,255,255)
	GameTooltip:AddDoubleLine(" ", "t:皮甲   t:盾", 255,255,255, 255,255,255)
	GameTooltip:AddDoubleLine("条件判断:", "&   与", nil,nil,nil, 255,255,255)
	GameTooltip:AddDoubleLine(" ", "|   或者", 255,255,255, 255,255,255)
	GameTooltip:AddDoubleLine(" ", "!   排除", 255,255,255, 255,255,255)
	GameTooltip:Show()
end)
