...
local function BuildFriendTable(total)
	...
	for i = 1, total do
		...
		if status == "<"..AFK..">" then
			status = "|cffff0000[离开]|r"
		elseif status == "<"..DND..">" then
			status = "|cffE7E716[忙碌]|r"
		end
...
local function Update(self, event)
	...
	Text:SetFormattedText(displayString, "好友", totalOnline + BNTotalOnline)
...
Stat:SetScript("OnEnter", function(self)
	...
	if totalonline > 0 then
		...
		GameTooltip:AddDoubleLine("好友列表:", format(totalOnlineString, totalonline, totalfriends),tthead.r,tthead.g,tthead.b,tthead.r,tthead.g,tthead.b)
		if totalOnline > 0 then
			GameTooltip:AddLine(' ')
