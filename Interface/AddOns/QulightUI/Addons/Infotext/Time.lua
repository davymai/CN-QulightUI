...
if Qulight["datatext"].Wowtime and Qulight["datatext"].Wowtime > 0 then
	...
	Text:SetFont(Qulight["media"].font, 12, "OVERLAY")
	...
	local function Update(self, t)
		...
		if int < 0 then
			...
			if Qulight["datatext"].Time24 == true then
				if pendingCalendarInvites > 0 then
					Text:SetText("|cffFF0000"..Hr24..":"..Min.." |cffffffff|r")
				else
					Text:SetText(qColor..Hr24..":"..Min.." |cffffffff|r")
				end
			else
				if Hr>=12 then
	...
	Stat:SetScript("OnEnter", function(self)
		...
		for i=1, pvp do
			...
			GameTooltip:AddDoubleLine("|cfffff45c计时|r".." "..name,timeleft)
		end
		GameTooltip:AddLine(" ")
		...
		if Qulight["datatext"].Localtime == true then
			...
			if Min<10 then Min = "0"..Min end
			if Qulight["datatext"].Time24 == true then
				GameTooltip:AddDoubleLine("本地时间: ",Hr .. ":" .. Min);
			else
				if Hr>=12 then
				Hr = Hr-12
				if Hr == 0 then Hr = 12 end
					GameTooltip:AddDoubleLine("本地时间: ",Hr .. ":" .. Min.." PM");
				else
					if Hr == 0 then Hr = 12 end
					GameTooltip:AddDoubleLine("本地时间: ",Hr .. ":" .. Min.." AM");
				end
			end
		else
			Hr24 = tonumber(date("%H"))
			...
			Min = date("%M")
			if Qulight["datatext"].time24 == true then
				GameTooltip:AddDoubleLine("服务器时间: ",Hr24 .. ":" .. Min);
			else
				if Hr24>=12 then
					GameTooltip:AddDoubleLine("服务器时间: ",Hr .. ":" .. Min.." PM");
				else
					GameTooltip:AddDoubleLine("服务器时间: ",Hr .. ":" .. Min.." AM");
				end
			end
		end
